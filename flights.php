        	...
        	<div class="card">
				...
				<?php else: ?>
					<div class="row align-items-center">
						...
						<div class="row align-items-center">
					<div class="col-md-3">
						<img src="assets/img/1676607060_SV.png" alt="">
					</div>
					<div class="col-md-6">
						 <p><b>Beijing Capital International Airport, Chaoyang-Shunyi, Beijing - Bhubneshwar Airport, Bhubneshwar</b></p>
						 <p><small>Airline: <b>Saudi</b></small></p>
						 <p><small>Departure: <b>11:00 AM</b></small></p>
						 <p><small>Arrival: <b>12:00 PM</b></small></p>
						 <p>Available Seats : <b><h4>300</h4></b></p>
					</div>
					<div class="col-md-3 text-center align-self-end-sm">
						<h4 class="text-right"><b>4000</b></h4>
						<button class="btn-outline-primary  btn  mb-4 book_flight" type="button" data-id=""  data-name="">Book Now</button>
					</div>
				</div>
					</div>
					<hr class="divider" style="max-width: 60vw">
					...
					<div class="col-md-6">
						 <p><b>Bhubneshwar Airport, Bhubneshwar - China, China</b></p>
						 <p><small>Airline: <b>Cebu Pacific</b></small></p>
						 <p><small>Departure: <b>1:00 AM</b></small></p>
						 <p><small>Arrival: <b>3:00 PM</b></small></p>
						 <p>Available Seats : <b><h4>200</h4></b></p>
					</div>
					<div class="col-md-3 text-center align-self-end-sm">
						<h4 class="text-right"><b>4000</b></h4>
						<button class="btn-outline-primary  btn  mb-4 book_flight" type="button" data-id=""  data-name="">Book Now</button>
