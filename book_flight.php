<div class="container-fluid">
	...
	<form action="" id="book-flight">
		...
		<div class="form-group row" id="qty">
			<div class="col-md-3">
			<label for="" class="control-label">Persons</label>
		...
		<div id="row-field" style="display: none">
			<div class="row ">
				<div class="col-md-12 text-center">
					<!-- <button class="btn btn-primary btn-sm" onclick="myFunction()"  >Save</button> -->
					<button class="btn btn-secondary width445 btn-sm" type="button" data-dismiss="modal">Cancel</button>
				</div>
			</div>
		</div>
